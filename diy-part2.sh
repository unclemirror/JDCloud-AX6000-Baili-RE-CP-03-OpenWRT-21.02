...
mkdir -p package/CloudFlared/luci-app-cloudflared/root/etc/cloudflared
mv /tmp/cloudflared package/CloudFlared/luci-app-cloudflared/root/etc/cloudflared/cloudflared >/dev/null 2>&1
