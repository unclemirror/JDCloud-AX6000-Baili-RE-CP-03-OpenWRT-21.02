...
mkdir -p feeds/luci/applications/luci-app-cloudflared/root/etc/client
mv /tmp/cloudflared feeds/luci/applications/luci-app-cloudflared/root/etc/client/cloudflared >/dev/null 2>&1
